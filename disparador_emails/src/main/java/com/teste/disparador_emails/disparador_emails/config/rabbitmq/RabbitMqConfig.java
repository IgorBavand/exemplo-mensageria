package com.teste.disparador_emails.disparador_emails.config.rabbitmq;
...
public class RabbitMqConfig {
    ...
    private void adiciona(){
        ...
        Queue filaEmail = this.fila(Filas.EMAIL.toString());
        DirectExchange troca = this.trocaDireta();
        Binding ligacao = this.relacionamento(filaEntregas, troca);
        Binding binding = this.relacionamento(filaEmail, troca);
